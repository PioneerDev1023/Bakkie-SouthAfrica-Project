...
<div class="container">
    ...
    <div style="margin-bottom: 25px;">
        <a href="inc/logout.inc.php"><button class="btn btn-sm btn-warning mt-4" style="color: white;">Log Out <i class='fas fa-sign-out-alt'></i></button></a>
    ...
    <form class="form" id="register-form" enctype="multipart/form-data" style="border-top: 2px solid lightgrey; margin-bottom: 15px; display: none;">
        <div class="oper-btns d-flex" style="flex-direction: row-reverse;">
            <button class="signout-btn btn btn-danger" style="margin-top: 10px; width: 120px; margin-left: 10px;" onclick="javascript:return confirm('Are you sure you want to cancel registration?')"><i class='fas fa-trash-alt'></i> Sign out</button>
            <!-- Re-edit Modal -->
            ...
            <div class="modal fade" id="myModal" style="display: none;">
                ...
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">Re-edit your infos</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    
                    <!-- Modal body -->
                    <div class="modal-body">
                        <form action="inc/re-edit.php" method="post" class="form" id="re-edit-form" enctype="multipart/form-data">
                            <div class="form-group d-flex flex-wrap">
                                <label class="form-group col-md-3 col-sm-12 col-xs-12">
                                    <i class="fa fa-image"></i>Picture of your face</br>(head & shoulders)*<input type="file" name="m_user_photo" id="m_user_photo" class="form-control" accept="image/x-png,image/gif,image/jpeg,image/jpg,image/bmp" data-rule="required" data-msg="Choose your photo" onchange="previewFile1()">
                                    <div class="validation text-left text-danger"></div>
                                    <img class="user-img" src="" width="100%" alt="Image preview...">
                                </label>
                                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                                    <input type="text" name="nickname" id="m_nickname" class="nickname form-control" placeholder="Enter your nickname (what people call you)*" data-rule="minlen:2" data-msg="Please enter your nickname" style="margin-bottom: 10px;">
                                    <div class="validation text-left text-danger"></div>
                                    ...
                                    <div class="form-group d-flex justify-content-between flex-wrap">
                                        <div class="form-group col-12 d-flex align-items-center justify-content-between">
                                            <h4>R</h4>
                                            <input type="number" name="daily_rate" id="m_daily_rate" class="daily-rate form-control col-4" placeholder="Amount*" data-rule="required" data-msg="Please enter Daily Rate" >
                                            <div class="validation text-left text-danger"></div>
                                        ...
                                        <div class="form-group col-12 d-flex align-items-center justify-content-between">
                                            ...
                                            <input type="number" name="free_rate" id="m_free_rate" class="free-rate form-control col-3" placeholder="Enter Km's*" data-rule="minlen:1" data-msg="Please enter Free Km's">
                                            <div class="validation text-left text-danger"></div>
                                            <h6 style="margin-bottom: 0px;">km's</h6>
                                            
                                            <h4 style="margin-bottom: 0px; padding-left: 20px">R</h4>
                                            <input type="number" name="hoc_rate" id="m_hoc_rate" class="hoc-rate form-control col-3" placeholder="Amount*" data-rule="minlen:1" data-msg="Please enter Ad Hoc Rate">
                                            <div class="validation text-left text-danger"></div>
                                            <h6 style="margin-bottom: 0px;">Ad Hoc Rate</h6>
                                        </div>                        
                                        <div class="validation text-left text-danger"></div>
                                    </div>
                                    <input type="number" name="cell_number" id="m_cell_number" class="form-control" placeholder="Enter 10-digit WhatsApp Cell Number*" data-rule="exact:10" data-msg="Please enter your 10-digit cell number">
                                    <div class="validation text-left text-danger"></div>
                                </div>
                                <label class="form-group col-md-3 col-sm-12 col-xs-12">
                            ...
                            <button type="submit" class="edit-register btn btn-block" style="width: 350px; margin: 0 auto;" id="edit-register">Register</button>
                        </form>
                    </div>
                    ...
                    <p>After admin 's approval, your infos will be changed.</p>
                    </div>
        ...
        <h2 style="margin-top: 30px; font-weight: 800; color: green;">Your register has been approved.</h2>
        ...
        <div class="form-group d-flex flex-wrap">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group d-flex justify-content-between" style="box-sizing: border-box; margin-bottom: 5px;">
                    <input name="country" id="country" class="country form-control" style="margin-right: 10px; display:none;" required data-rule="minlen:5" data-msg="Please select on your province">
                    </input>
                    <input name="province" id="province" class="province form-control" style="margin-right: 10px; font-weight: 700; text-align: center;" placeholder="Province" readonly>
                    </input>
                    <input name="hometown" id="hometown" class="hometown form-control" style="font-weight: 700; text-align: center;" placeholder="City/Town" readonly>
                    </input>
                </div>
