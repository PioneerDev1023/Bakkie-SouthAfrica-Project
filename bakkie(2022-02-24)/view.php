        ...
        <div class="bg-img">
            <div class="menu d-flex justify-content-between">
                ...
                <div class="menu-bar d-flex">
                    ...
                    <!-- <i class="fas fa-sign-in-alt" style="color: #007bff; padding-right: 8px;"></i> -->
                    <!-- <a href="./RU/index.php" class="btn btn-primary" style="width: 70px; color: white;">Login</a> -->
                    <a href="?logout" class="btn btn-warning" style="width: 70px; color: white;">Logout</a>
                </div>
            </div>
        </div>
