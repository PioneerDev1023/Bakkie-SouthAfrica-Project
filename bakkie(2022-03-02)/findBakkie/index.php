                ...
                <form action="inc/handler.inc.php" method="post" class="form" id="register-form" enctype="multipart/form-data" style="border-bottom: 5px ridge lightgrey; margin-bottom: 15px;">
                    ...
                    <div class="form-group d-flex flex-wrap">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="modal-dialog  modal-dialog-centered">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="d-flex">
                                                <input type="number" name="mcountrycode" id="mcountrycode" class="form-control col-3 mcountrycode" placeholder="+27" style="margin: 5px auto; text-align: center; font-weight: 700;">
                                                <input type="number" name="mcellnumber" id="mcellnumber" class="form-control col-8 mcellnumber" placeholder="Cell Number" style="margin: 5px auto; text-align: center; color: red; font-weight: 700;">
                                            </div>
                                            <textarea class="col-11 mt-3" style="border-color: lightgrey;" rows="5"></textarea>
                                        </div>
                            ...
                            <div class="d-flex justify-content-center" id="cellnumber_area">
