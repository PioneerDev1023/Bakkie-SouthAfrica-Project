            ...
            <div class="col-12 justify-content-center text-center form-card">
                ...
                <div class="d-flex justify-content-between ">
                    ...
                    <!-- <div class="btn-group btn-group-md d-flex">
                        ...
                        <a href="re-edit.php"><button type="button" class="btn btn-success" style="font-weight: 700; width: 100px;">Edit</button>
                        <a href="./all-view/all.php"><button type="button" class="btn btn-primary" style="font-weight: 700; width: 100px;">All</button></a>
                    </div> -->
                    <div class="d-flex">
                ...
                <h2 style="font-weight: 800; text-decoration: underline;">New User</h2>
                ...
                <form class="form-new" id="register-form-new" enctype="multipart/form-data" style="border-bottom: 2px solid lightgrey; margin-bottom: 25px;">
                    ...
                    <div class="form-group d-flex flex-wrap">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <input type="text" name="nickname" id="nickname_new" class="form-control" placeholder="Your nickname(what people call you)" style="margin-bottom: 5px; text-align: center; color: red; text-decoration: underline; font-weight: 700;" readonly>
                            ...
                            <div class="form-group d-flex justify-content-between" style="box-sizing: border-box; margin-bottom: 5px;">
                                ...
                                <input name="province" id="province_new" class="form-control" style="margin-right: 10px; font-weight: 700; text-align: center;"  placeholder="Province" readonly>
                                </input>
                                <input name="hometown" id="hometown_new" class="form-control" style="font-weight: 700; text-align: center;" placeholder="City/Town"  readonly>
                                </input>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between flex-wrap" style=" margin-bottom: 5px;">
                                <div class="col-12 d-flex align-items-center justify-content-between">
                                    ...
                                    <input type="number" name="daily_rate" id="daily_rate_new" class="form-control col-4" placeholder="Amount" style="    margin-bottom: 10px; text-align: center; color: red; font-weight: 700;"  readonly>
                        ...
                        <label class="btn btn-secondary col-md-3 col-sm-12 col-xs-12" style="background-color: white; border: none; color: red; margin: auto;">
                            ...
                            <i class="fa fa-image"></i><img class="bakkie-img" src="./../../images/bakkie.jpg" width="100%" alt="No bakkie photo">
                        </label>                          
                ...
                <form class="form" id="register-form" enctype="multipart/form-data" style="border-bottom: 2px solid lightgrey; margin-bottom: 25px;">
                    ...
                    <div class="form-group d-flex flex-wrap">
                        <label class="btn btn-secondary col-md-3 col-sm-12 col-xs-12" style="background-color: white; border: none; margin: auto; color: red;">
                            <!-- <i class="fa fa-image"></i>Picture of your face(head & shoulders) -->
                            <!-- <input type="file" name="user_photo" id="user_photo" class="form-control" accept="image/x-png,image/gif,image/jpeg,image/jpg,image/bmp" data-rule-required="true" onchange="previewFile1()"> -->
                            <img class="user-img" id="user_photo" src="./../../images/driver.jpg" width="100%" alt="Driver never want to change the approved last photo.">
                        </label>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <label class="btn btn-secondary col-md-3 col-sm-12 col-xs-12" style="background-color: white; border: none; color: red; margin: auto;">
                            <!-- <i class="fa fa-image"></i>Picture of your bakkie(front & side-numberplate blanked)
                            <input type="file" name="bakkie_photo" id="bakkie_photo" class="form-control" accept="image/x-png,image/gif,image/jpeg,image/jpg,image/bmp" data-rule-required="true" onchange="previewFile2()"> -->
                            <i class="fa fa-image"></i><img class="bakkie-img" src="./../../images/bakkie.jpg" width="100%" alt="Driver never want to change the approved last photo.">
                        </label>                          
