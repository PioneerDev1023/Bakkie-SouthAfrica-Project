$(document).ready(function(){
    ...
    $.get("./get_alluserdata.php", function(data, status){
        ...
        for(var i = 0; i < obj_len; i++){
            ...
            $newTaskTemplate.find('#form-content').html("<button onclick='displayDate(`" + show_data[i]['email'] + "`)' style='margin-right: 10px; display: none;' class='btn btn-primary approve-btn'>Approve</button><button onclick='displayDate1(`" + show_data[i]['email'] + "`)' class='btn btn-danger disapprove-btn'>Delete</button>");
