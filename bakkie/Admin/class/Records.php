...
class Records {	
	...
	private $recordsTable = 'employers';
	public $id;
    public $name;
    public $surname;
    public $email;
	...
	public function listRecords(){
		...
		while ($record = $result->fetch_assoc()) { 				
			...
			$rows[] = '<button type="button" name="update" id="'.$record["id"].'" class="btn btn-warning btn-xs update" style="display: none;">Update</button>';
			$records[] = $rows;
		}
	...
	// 		SET name= ?, surname = ?, email = ?, cellnumber = ?, timeStamp = ?
	// 		WHERE id = ?");
	...
	// 		$this->timdStamp = htmlspecialchars(strip_tags($this->regdate));
			
			
	// 		$stmt->bind_param("sisssi", $this->name, $this->surname, $this->email, $this->cellnumber, $this->timeStamp, $this->id);
