                ...
                <form action="inc/handler.inc.php" method="post" class="form" id="register-form" enctype="multipart/form-data" style="border-bottom: 2px solid lightgrey; margin-bottom: 15px;">
                    ...
                    <div class="form-group d-flex flex-wrap">
                        <label class="btn btn-secondary col-md-3 col-sm-12 col-xs-12" style="background-color: white; border: none;">
                            ...
                            <img class="user-img" id="user_photo" src="./../../RU/inc/uploads/f45cd07736ebaad37c5d06b381a75d89.jpg" height="100%" width="100%" alt="No driver photo">
                        </label>
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <input type="text" name="nickname" id="nickname" class="form-control" placeholder="Enter your nickname(what people call you)" style="margin-bottom: 5px; text-align: center; color: red; text-decoration: underline; font-weight: 700;">
                            ...
                            <div class="form-group d-flex justify-content-between" style="box-sizing: border-box; margin-bottom: 5px;">
                                ...
                                <input name="province" id="province" class="form-control" style="margin-right: 10px; font-weight: 700; text-align: center;">
                                </input>
                                <input name="hometown" id="hometown" class="form-control" style="font-weight: 700; text-align: center;">
                                </input>
                            </div>
                        ...
                        <label class="btn btn-secondary col-md-3 col-sm-12 col-xs-12" style="background-color: white; border: none; color: red;">
                            ...
                            <i class="fa fa-image"></i><img class="bakkie-img" src="" height="100%" width="100%" alt="No bakkie photo">
                        </label>                          
