    ...
    if ($password != $re_pass) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if ($resultCheck > 0) {
                ...
                $sql = "INSERT INTO employers (username, surname, cellnumber, email, province, hometown,  password, timeStamp) VALUES('$username', '$surname', '$cellnumber', '$email', '$province', '$hometown',  '$passHashed','$date')";
